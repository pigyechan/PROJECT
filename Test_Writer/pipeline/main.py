...
def main() -> None:
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        print(f"\n=== [Step 2] Critique: QA 비평 (iteration {iteration}) ===")
        ...
        # Step 4: Validate — 코드 기반 계약 게이트
        print(f"=== [Step 4] Validate: 스키마/금지패턴/품질 검증 ===")
        verdict_data = validate_contract(output_path, verdict_path)
        ...
        print(f"\n=== [Refine] 테스트 케이스 개선 (iteration {iteration}) ===")
